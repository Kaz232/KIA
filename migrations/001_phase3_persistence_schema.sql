...
-- Read policies for authenticated and anon users (system queries)
...
-- Execution & Task Access (Full access for service role and owners, read for viewers)
...
-- Storage bucket creation instruction for Supabase Storage:
-- INSERT INTO storage.buckets (id, name, public) VALUES ('gag-artifacts', 'gag-artifacts', true) ON CONFLICT (id) DO NOTHING;
